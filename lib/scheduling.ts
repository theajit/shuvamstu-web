...
export type LocationMode = 'online' | 'customer_location' | 'temple' | 'office';
...
export function occupiedMinutes(service: SpiritualService) {
  return service.bufferBeforeMinutes + service.durationMinutes + service.bufferAfterMinutes;
}

export function serviceBySlug(slug: string) {
  return schedulingServices.find(service => service.slug === slug);
}
